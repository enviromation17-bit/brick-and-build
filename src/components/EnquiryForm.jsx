...
export default function EnquiryForm({
  ...
  if (done) {
    return (
      <div className="rounded-2xl bg-paper2 border border-line p-10" role="status" aria-live="polite">
    ...
    <form onSubmit={onSubmit} noValidate aria-label="Enquiry form">
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input className="field-input" id="name" name="name" type="text" required autoComplete="name" aria-required="true" />
        </div>
        <div>
          ...
          <input className="field-input" id="phone" name="phone" type="tel" required autoComplete="tel" aria-required="true" />
        </div>
        {extraFields && (
          <>
            <div>
